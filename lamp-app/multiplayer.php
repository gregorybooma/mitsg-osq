...
<div id="column2">
    ...
    <h4 id="correctP1" class="stats">P1 Correct: </h4>
    <h4 id="wrongP1" class="stats">P1 Wrong: </h4>
    <h4 id="correctP2" class="stats">P2 Correct: </h4>
    <h4 id="wrongP2" class="stats">P2 Wrong: </h4>
