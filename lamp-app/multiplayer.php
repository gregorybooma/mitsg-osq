...
<script type="text/javascript" src="multicode.js"></script>
...
<div id="header">
	...
	<div style="float:right;position:absolute;top5px;left:510px;">
	        <table>
	        	<tr>
			        <td width="160">
			        	<span id="P1"><img id="imgP1" src="pics/key_q.png" border="0" align="absmiddle" vspace="4"  hspace="5"/>Player 1</span>&#160;&#160;&#160;&#160;
			        </td>
			        <td>
			        	<span id="P2"><img id="imgP2" src="pics/key_p.png" border="0" align="absmiddle" vspace="4" hspace="5"/>Player 2</span>
			        </td>
		        </tr>
	        </table>
        </div>
    <h1 id="title">MultiPlayer Game</h1>
...
<div id="column2">
    ...
    <h4 id="correctP1" class="stats" style="color:black">P1 Correct: </h4>
    <h4 id="wrongP1" class="stats" style="color:black">P1 Wrong: </h4>
    <h4 id="correctP2" class="stats" style="color:black">P2 Correct: </h4>
    <h4 id="wrongP2" class="stats" style="color:black">P2 Wrong: </h4>
